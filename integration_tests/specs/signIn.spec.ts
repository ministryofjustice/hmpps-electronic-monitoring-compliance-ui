...
import complianceApi from '../mockApis/complianceApi'
import DeviceComplianceListPage from '../pages/deviceComplianceListPage'

test.describe('SignIn', () => {
  test.beforeEach(async () => {
    await complianceApi.stubGetDeviceComplianceList()
  })
  ...
  test('User name visible in header', async ({ page }) => {
    ...
    const homePage = await DeviceComplianceListPage.verifyOnPage(page)
